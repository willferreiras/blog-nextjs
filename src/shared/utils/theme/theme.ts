...
declare module "@mui/material/styles" {
  interface TypographyVariants {
    ...
    customSectionTitle: React.CSSProperties;
    customPopUpTitle: React.CSSProperties;
  }
...
declare module "@mui/material/Typography" {
  interface TypographyPropsVariantOverrides {
    ...
    labelMedium: true;
    labelSmall: true;
    customSectionTitle: true;
    customPopUpTitle: true;
  }
}
    ...
    MuiTab: {
      styleOverrides: {
        root: {
          ...
          backgroundColor: colors.palette.surfaceDark,
          color: colors.text,
